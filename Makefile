...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer KeyChain NfcNci PicoTts PrintSpooler Stk UserDictionaryProvider BackupRestoreConfirmation DefaultContainerService ExternalStorageProvider FusedLocation InputDevices ProxyHandler SharedStorageBackup Shell CMSettingsProvider telresources
...
override_property += \
    ro.flyme.romer=Chopin_w \
    ro.product.model_romer=Moto-X-Pro_Chopin_w \
